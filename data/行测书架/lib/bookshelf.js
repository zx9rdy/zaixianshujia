...
var currentDemo,
  ...
  samples = {
    'yanyu' : {'path' : 'samples/yanyu/'},
    'panduan' : {'path' : 'samples/panduan/'},
    'ziliao' : {'path' : 'samples/ziliao/'},
    'shuliang' : {'path' : 'samples/shuliang/'},
    'changshi' : {'path' : 'samples/changshi/'},
    'chengyu' : {'path' : 'samples/chengyu/'},
    'shici' : {'path' : 'samples/shici/'},
    'leichang' : {'path' : 'samples/leichang/'}
  },
  status = {
    'unloaded' : 0,
    'loading' : 1,
